          ...
          s(t, [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  (this.plugins = Object.assign({}, this.plugins, e)), this
                );
              },
            },
            {
                    ...
                    if ("pointerdown" === t.state)
                      if (!1 !== t.trigger("touchMove", o)) {
                        if (
                          ...
                          var u =
                            1 === t.dragStart.scale && t.option("lockAxis");
                          if (u && !t.lockAxis) {
                            if (
                  ...
                  l
                    ? ((this.state = "panning"),
                      (this.velocity = {
                        ...
                        scale:
                          (1 / this.friction - 1) * (s - this.content.scale),
                      }),
                      this.startAnimation())
                    : this.endAnimation();
              },
                ...
                if ("decel" === this.state) {
                  ...
                  if (i || n) {
                    var h = ((i ? r.from : r.to) - this.content.y) * o,
                      d =
                        this.content.y + (h + this.velocity.y) / this.friction;
              ...
              value: function () {
                ...
                if (null === b) {
                  ...
                  (b =
                    ...
                    y[b] ||
                      (b =
                        y.length && b > y.length ? y[y.length - 1].index : 0),
                    (this.page = b),
                    (this.pageIndex = b);
                }
    ...
    var W = !(
      ...
      U = (function () {
        function t(e) {
          ...
          for (
            var i = 0,
              n = ["onReady", "onResize", "onTouchstart", "onTouchmove"];
            i < n.length;
            i++
          ) {
            var a = n[i];
          ...
          s(t, [
            ...
            },
            {
              ...
              value: function (t) {
                if (t.html)
                  return (
                    (t.src = t.html), (t.type = "html"), void delete t.html
                  );
                var e = t.src || "",
                ...
                if (!e || "string" == typeof e) {
                  if (
                    ...
                    (t.videoId = a),
                      (t.src =
                        "https://web.archive.org/web/20230112132341/https://www.youtube-nocookie.com/embed/"
                          .concat(a, "?")
                          .concat(o)),
                      (t.thumb =
                        t.thumb ||
                        "https://web.archive.org/web/20230112132341/https://i.ytimg.com/vi/".concat(
                          a,
                          "/mqdefault.jpg"
                        )),
                      (t.vendor = "youtube"),
                    ...
                    (n = e.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/))
                  ) {
                    var s = V(e, this.fancybox.option("Html.vimeo")),
                      r = encodeURIComponent(n[1]);
                    (t.videoId = r),
                      (t.src =
                        "https://web.archive.org/web/20230112132341/https://player.vimeo.com/video/"
                          .concat(r, "?")
                          .concat(s)),
                      (t.vendor = "vimeo"),
                      (i = "video");
                    ...
                    (n = e.match(
                      ...
                      ? ((t.src =
                          "//web.archive.org/web/20230112132341/https://maps.google."
                            .concat(n[1], "/?ll=")
                            .concat(
                              (n[2]
                                ? n[2] +
                  ...
                  i ||
                    ...
                    ("html5video" !== i && "video" !== i) ||
                      ...
                      t._width && t._height
                        ? (t.ratio =
                            parseFloat(t._width) / parseFloat(t._height))
                        : (t.ratio =
                            t.ratio || t.video.ratio || Z.video.ratio));
                }
              },
            },
            {
              ...
              value: function (t, e, i) {
                i.xhr && (i.xhr.abort(), (i.xhr = null)),
                  i.$iframe &&
                    ...
                    (i.$iframe.src =
                      "//web.archive.org/web/20230112132341/https://about:blank"),
                    (i.$iframe = null));
                var n = i.$content;
                "inline" === i.type &&
                  n &&
            ...
            },
            {
              ...
              value: function (t) {
                try {
                  ...
                  if (
                    "https://web.archive.org/web/20230112132341/https://player.vimeo.com" ===
                    t.origin
                  ) {
                    if ("ready" === e.event) {
                      var i,
            ...
            value: function (t) {
              ...
              if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
                var s = document.elementFromPoint(a.left + 1, a.top + 1) === n,
                  r =
                    document.elementFromPoint(a.right - 1, a.bottom - 1) === n;
                o = s && r;
              } else
                o =
...
/*
     ...
     INTERNET ARCHIVE ON 09:57:03 Aug 10, 2023.
...
/*
playback timings (ms):
  captures_list: 555.055
  exclusion.robots: 0.116
  exclusion.robots.policy: 0.103
  cdx.remote: 0.084
  esindex: 0.012
  LoadShardBlock: 70.116 (3)
  PetaboxLoader3.datanode: 68.396 (4)
  load_resource: 178.207
  PetaboxLoader3.resolve: 162.275
*/
